...
import { Copy, Trash as Trash2, Plus, X, MagnifyingGlass as Search, Code } from "@phosphor-icons/react";
...
export default function Snippets() {
    ...
    return (
        <div className="flex flex-col h-full bg-white dark:bg-[#212121] text-gray-900 dark:text-gray-100 p-6 overflow-y-auto">
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredSnippets.map(snippet => (
                            <div key={snippet.id} className="bg-white dark:bg-[#2f2f2f] border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden hover:shadow-lg transition-shadow flex flex-col">
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white dark:bg-[#2f2f2f] w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
